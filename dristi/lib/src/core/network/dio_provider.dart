...
import 'package:dristi/src/core/network/pretty_dio_logger.dart';
import 'package:dristi/src/core/network/request_headers.dart';
...
class DioProvider {
  ...
  static final PrettyDioLogger _prettyDioLogger = PrettyDioLogger(
      requestHeader: true,
      requestBody: true,
      responseBody: BuildConfig.instance.environment == Environment.dev,
