...
class SettingsData extends SettingsEntity {
  ...
  factory SettingsData.fromJson(dynamic json) {
    ...
    RatingsReviews? ratingsReviewsData = json['ratings_reviews'] != null
    ...
    Contribution? contributionData = json['contribution'] != null
    ...
    TermsServices? termsServicesData = json['terms_services'] != null
        ? TermsServicesData.fromJson(json['terms_services'])
        : null;

    PrivacyPolicy? privacyPolicyData = json['privacy_policy'] != null
